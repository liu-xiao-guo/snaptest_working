...
UBUNTU_TRANSLATION_DOMAIN="snaptest.liu-xiao-guo"
...
aptest.commands = bash $$PWD/snaptest/tests/autopilot/run
aptest.depends  = sub-snaptest

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/snaptest/tests/unit
unittest.depends  = sub-snaptest
